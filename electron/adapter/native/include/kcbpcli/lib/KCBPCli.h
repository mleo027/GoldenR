...
#define KCBP_DESCRIPTION_MAX		64
...
#define KCBP_PARAM_HEAD				10
#define KCBP_PARAM_DATAFORMAT       15
...
KCBPCLI_API int KCBPCLISTDCALL KCBPCLI_GetReply_Corrid(KCBPCLIHANDLE hHandle, tagCallCtrl *ptagCallCtrl);
