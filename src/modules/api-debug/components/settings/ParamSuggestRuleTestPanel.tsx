...
function RuleTestResultPanel({
    ...
    testResponse: DbSuggestResponse;
    testResolvedRule?: ParamFieldRule;
    matchedRank?: number;
    matchReasons: string[];
    onViewSql?: (sql: string, boundParams?: Record<string, string | number>) => void;
    ...
    return (
        <div className="settings-panel-group mt-6 param-suggest-test-panel">
            ...
            <RuleTestControls
                ...
                onTestFieldChange={onTestFieldChange}
                onTestContextChange={onTestContextChange}
                onTestKeywordChange={onTestKeywordChange}
                onRunTest={onRunTest}
            />
            {testField.trim() ? (
