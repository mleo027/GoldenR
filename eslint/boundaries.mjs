...
const dependencyPolicies = [
     ...
     */
    {
        ...
        allow: { to: el('capabilities', 'runtime', 'util', 'constants', 'types', 'lib', 'shared') },
    },
    ...
    {
        from: el('ia-util'),
        allow: { to: el('ia-util', 'ia-const', 'util', 'constants', 'types', 'lib', 'shared') },
    },
    {
        from: el('ia-worker'),
        allow: { to: el('ia-worker', 'constants', 'types', 'lib', 'shared') },
    },
