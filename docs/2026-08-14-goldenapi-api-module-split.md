...
按用户确认的“纯 API 调试”档执行：移除 TCI、AutoQC、知识库、SQL Debugger、数据库环境、交易所文件、Agent Server、Agent Chat、LLM、RAG 与 Tunnel 等无关能力。
...
- 共享代码：`shared/kcbp`、`shared/suggest`、`shared/test` 中脚本 API 所需子集、`shared/platform/undo`、`shared/utils/textHighlight`。
